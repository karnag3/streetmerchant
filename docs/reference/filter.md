...
| `MAX_PRICE_SERIES_4080super` | Maximum price allowed for a match, applies 4080 Super series cards (does not apply to these sites: Nvidia, Asus, EVGA) |
...
| `MAX_PRICE_SERIES_RX7900XTX` | Maximum price allowed for a match, applies AMD RX 7900 XTX |
...
| Nvidia RTX 4080 SUPER | `4080super` |
